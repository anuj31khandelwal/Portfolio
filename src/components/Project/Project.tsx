          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/anuj31khandelwal/Salon-It" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Salon-It!</h3>
              <p> Developed a web application designed for salons to manage their services and appointments, while allowing customers to search for salons or specific services. The project is structured similarly to how Zomato shows restaurants and dishes, but instead of food, it lists salon services like beard styling, facials, and more. The platform supports multiple salons and allows users to book, manage, and cancel appointments. </p>
            </div>
            <footer> <ul className="tech-list"> <li>Spring Boot</li> <li>API Gateway</li> <li>ReactJS</li> <li>SQL</li></ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="hhttps://github.com/anuj31khandelwal/Weather-forecasting-Upgraded" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://github.com/anuj31khandelwal/Weather-forecasting-Upgraded" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Weather-forecasting-Upgraded</h3>
              <p>
                Weather Monitoring Web App (weather-monitoring-app): A React-based frontend for monitoring weather conditions, showing current weather, temperature summaries, and weather alerts.
                </p><p>
                Weather Monitoring Backend System (weather-monitoring-system): A Spring Boot-based backend that fetches weather data from external APIs, processes it, and serves it to the frontend.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/anuj31khandelwal/Rule-Engine" target="\_blank" rel="noreferrer">
